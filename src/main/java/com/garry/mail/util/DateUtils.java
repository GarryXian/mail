...
public class DateUtils {
     ...
     * @return 间隔月份
     */
    public static int dateBetweenInMonth(Date startDate, Date endDate) {
        int monthDiff = getMonth(endDate) - getMonth(startDate);
        int yearDiff = (getYear(endDate) - getYear(startDate)) * 12;
